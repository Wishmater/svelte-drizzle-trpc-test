	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				raised:
					'bg-primary text-primary-foreground hover:bg-primary/90 shadow-md shadow-ring/60 hover:scale-[1.02] hover:shadow-lg hover:shadow-ring/60 focus:opacity-[0.85] active:scale-[0.98] active:shadow-sm active:shadow-ring/60'
			},
			size: {
